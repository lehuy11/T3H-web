  ...
  return (
    <>
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">150 devices</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Nhập thiết bị</p>
                      <Card.Title as="h4">130</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
        ...
        {/* line chart thiết bị nhập xuất và hư hỏng */}
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">DEVICES</Card.Title>
                <p className="card-category">1 quý</p>
              </Card.Header>
              <Card.Body>
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  Nhập <i className="fas fa-circle text-danger"></i>
                  Xuất <i className="fas fa-circle text-warning"></i>
                  Hư hỏng
                </div>
                <hr></hr>
                <div className="stats">
